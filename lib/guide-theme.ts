...
const urban: GuideThemeClasses = {
    ...
    sectionLabel:     'text-[#888] font-bold tracking-[0.2em] uppercase',
    ...
    chipLayout:       'inline',
    perChipColors:    [],
    guideCardTag:     'text-[#888] font-bold tracking-[0.2em] uppercase',
    ...
    guideCardChevron: 'bg-[#0F0F0F] border border-[#555] text-[#888] group-hover:text-[#00E5FF]',
