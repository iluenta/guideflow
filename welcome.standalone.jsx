    ...
    <div className="discover">
      ...
      <div className="discover__grid">
        <div className="discover__card">
          <div className="discover__card-img" style={{ backgroundImage: `url(${window.__resources.discoverEat})` }} />
          <div className="discover__card-veil" />
          <div className="discover__card-label">Dónde comer</div>
        </div>
        <div className="discover__card">
          <div className="discover__card-img" style={{ backgroundImage: `url(${window.__resources.discoverDo})` }} />
          <div className="discover__card-veil" />
