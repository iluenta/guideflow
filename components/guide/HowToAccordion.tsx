...
function HowToAccordionItem({ item, currentLanguage, accessToken, propertyId }: { item: HowToItem, currentLanguage: string, accessToken?: string, propertyId?: string }) {
...
export function HowToAccordion({ items, currentLanguage = 'es', accessToken, propertyId }: HowToAccordionProps) {
    return (
