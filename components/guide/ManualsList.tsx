...
export function ManualsList({ manuals }: ManualsListProps) {
                            ...
                            <div className="sticky top-0 bg-white/80 backdrop-blur-md z-10 px-6 py-6 border-b border-slate-100">
                                <DialogHeader>
                                    <div className="flex items-center gap-3 mb-1">
                                        ...
                                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Manual Oficial</span>
                                    </div>
                                    <DialogTitle className="text-2xl font-black text-slate-900">
                                        {manual.appliance_name} - {manual.brand} {manual.model}
                                    </DialogTitle>
                                </DialogHeader>
                            </div>
                            <div className="p-8 prose prose-slate prose-sm max-w-none prose-headings:font-black prose-headings:text-slate-900 prose-p:text-slate-600 prose-p:leading-relaxed prose-strong:text-slate-900 prose-strong:font-bold">
                                <ReactMarkdown>{manual.manual_content}</ReactMarkdown>
                            </div>
                        </DialogContent>
                    </Dialog>
                ))}
